...
makeTopologyNtupleMiniAOD = cms.EDAnalyzer('MakeTopologyNtupleMiniAOD',
					   ...
					   BadChargedCandidateFilterToken = cms.InputTag("BadChargedCandidateFilter"),
					   BadPFMuonFilterToken = cms.InputTag("BadPFMuonFilter"),
	...
	'HLT_Mu23_TrkIsoVVL_Ele12_CaloIdL_TrackIdL_IsoVL_v7', 	#Muon+Electron
	...
	'HLT_Mu8_TrkIsoVVL_Ele23_CaloIdL_TrackIdL_IsoVL_v7', 	#Muon+Electron
